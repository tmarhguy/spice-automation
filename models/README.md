...
Obtain the model card from your [ESE 3700](https://www.engineering.upenn.edu/~ese3700/) course materials or your local Electric VLSI export setup. **Do not commit** proprietary or course-restricted model files to this repository.
